    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="almacenarUsuario" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-group row">
                            <label for="confirmpassword" class="col-md-4 col-form-label text-md-right">Confirmar contraseña</label>
                        ...
                        <div class="form-group row">
                            <label for="conocimientos" class="col-md-4 col-form-label text-md-right">Cursos</label>
